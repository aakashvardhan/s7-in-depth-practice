...
class model3(nn.Module):
    def __init__(self, n_channels=16):
        ...
        # Convolution Block 1
        self.conv1 = ConvBlock(1, n_channels // 4) # output_size = 26, RF = 3
        self.conv2 = ConvBlock(n_channels // 4, n_channels // 2) # output_size = 24, RF = 5
        self.conv3 = ConvBlock(n_channels // 2, n_channels) # output_size = 22, RF = 7
